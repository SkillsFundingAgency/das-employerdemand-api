...
namespace SFA.DAS.EmployerDemand.Api.UnitTests.Controllers.Demand
{
    public class WhenPostingCreateEmployerDemandNotificationAudit
    {
        ...
        {
            //Act
            var actual = await controller.CreateDemandNotificationAudit(id, courseDemandId) as CreatedResult;
            ...
            [Greedy] DemandController controller)
        {
            ...
            //Act
            var actual = await controller.CreateDemandNotificationAudit(id, courseDemandId) as StatusCodeResult;
